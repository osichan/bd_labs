...
def handle_404(error: int) -> Response:
    """
    Informs user that object_dao.py not found in DB
    :param error: status code
    :return: Response object_dao.py
    """
...
def handle_409(error: int) -> Response:
    ...
    :return: Response object_dao.py
    """
    return make_response("Such object_dao.py is already exists in DB", HTTPStatus.CONFLICT)
